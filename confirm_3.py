...
def update(event=None):
    ...
    dumb=StringVar()
    en1=tk.Entry(updatetk,textvariable=dumb,font=('Cascadia Mono SemiLight',14))
...
def search():
    ...
    dumb=StringVar()
    en1=tk.Entry(searchtk,textvariable=dumb,font=('Cascadia Mono SemiLight',14))
    en1.place(x=730,y=53)
    ...
    def searchwithame():
        ...
        lab1=tk.Label(nametk,text='Enter the name of the movie whose data you want to search: ',font=('Cascadia Mono SemiLight',18),bg='#42c8f5')
        ...
        en2=tk.Entry(nametk,textvariable=output,font=('Arial',14),bg='#42c8f5',relief='flat')

        #Placing the entry boxes
        en1.place(x=825,y=59)
        en2.place(x=450,y=100)
    ...
    def searchwithid():
        ...
        lab1=tk.Label(idtk,text='Enter the IMDB ID of the movie whose data you want to search: ',font=('Cascadia Mono SemiLight',18),bg='#42c8f5')
        ...
        en2=tk.Entry(idtk,textvariable=output,font=('Arial',14),bg='#42c8f5',relief='flat')
        ...
        def finallysearching(event=None):
            try:
                ...
                mydb=sq.connect(host='localhost', user='root', password='root', database='movie_database')
                cursor=mydb.cursor()
                cursor.execute("SELECT * FROM Movies WHERE IMDB_id LIKE '%{}%'".format(name))
                result=cursor.fetchall()

...
def update(event=None):
    ...
    lab1=tk.Label(updatetk,text='enter 1 to use movie name or 2 to use imdb id:',font=('Cascadia Mono SemiLight',14),bg='#42c8f5')
    ...
    def updatewithname():
        ...
        nametk.protocol('WM_DELETE_WINDOW',on_closing)
    ...
    def updatewithid():
        ...
        idtk.protocol('WM_DELETE_WINDOW',on_closing)
